        ...
        <GuestLayout>
            <Container size="lg" py={48}>
                ...
                <Stack align="center" mb={30} gap={8}>
                    ...
                    <Text className=" text-lg text-[#636363]">This Policy is intended for Amazon, our partners, and customers to understand how RunAnalytic securely manages Amazon Information in line with Amazon’s requirements.
                    </Text>

                    <Text className="text-lg text-[#636363]" style={{ lineHeight: '1.8' }}>
                ...
                <List spacing={10} withPadding listStyleType="disc" className="text-lg text-[#636363] font-weight-500 mb-6">

                        <List.Item>Amazon’s <Anchor href="https://sellercentral.amazon.es/mws/static/policy?documentType=DPP&locale=en_EN" target="_blank" className="text-lg">Data Protection Policy (DPP)</Anchor>
                        </List.Item>
                        <List.Item>Amazon’s <Anchor href="https://sellercentral.amazon.es/mws/static/policy?documentType=AUP&locale=en_EN" target="_blank" className="text-lg">Acceptable Use Policy (AUP)
                        </Anchor>
                        </List.Item>
                        <List.Item>The <Anchor href="https://developer-docs.amazon.com/sp-api/docs/welcome?ld=ASXXSPAPIDirect&pageName=US%3ASPDS%3ASPAPI-home" target="_blank" className="text-lg"> Amazon Services API Developer Agreement
                        </Anchor>
                        </List.Item>
                    </List>
                    <Text className="text-lf text-[#636363] m-6">For broader information about how we handle data and user privacy, please see our <Anchor component={Link} to={PATH_PAGES.privacy} className="text-lg">Privacy Policy</Anchor>.</Text>
                ...
                <Stack gap={48}>
                    ...
                    <Stack gap={24}>
                        ...
                        <List spacing={10} withPadding listStyleType="disc" className=" text-[#636363] font-weight-500 text-lg">
                    ...
                    <Stack gap={24}>
                        ...
                        <List spacing={10} withPadding listStyleType="disc" className="text-lg text-[#636363] font-weight-500">
                            ...
                            <List.Item>For broader information about how RunAnalytic protects personal data beyond Amazon Information, see our <Anchor component={Link} to={PATH_PAGES.privacy} className="text-lg">Privacy Policy</Anchor>.</List.Item>
                    ...
                    <Stack gap={24}>
                        ...
                        <List spacing={10} withPadding listStyleType="disc" className="text-lg text-[#636363] font-weight-500">
                            <List.Item >RunAnalytic complies with <Anchor href="https://sellercentral.amazon.es/mws/static/policy?documentType=DPP&locale=en_EN" target="_blank" className="text-lg">Amazon’s DPP, AUP</Anchor>, and <Anchor href="https://developer-docs.amazon.com/sp-api/docs/welcome?ld=ASXXSPAPIDirect&pageName=US%3ASPDS%3ASPAPI-home" target="_blank" className="text-lg">Developer Agreement</Anchor>.
                            </List.Item>
                    ...
                    <Stack gap={24}>
                        ...
                        <List spacing={10} withPadding listStyleType="disc" className="text-lg text-[#636363] font-weight-500">
                            ...
                            <List.Item>
                                Webiste: <Anchor href="https://www.runanalytic.com/" className="text-lg">www.runanalytic.com</Anchor>
                            </List.Item>
                        </List>
                    </Stack>
                </Stack>
