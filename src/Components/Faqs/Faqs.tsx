...
const FaqData = [
  {
    id: "what-is",
    question: "What does RunAnalytic do and how does it comply with Amazon's SP-API policies?",
    answer: (
  ...
  {
    id: "benefit",
    question: "Who can benefit from using RunAnalytic?",
    answer: (
      <span className="text-base">
  ...
  {
    id: "compliance",
    question: "Does RunAnalytic comply with Amazon's SP-API guidelines and data protection policies?",
    answer: (
      <span className="text-base">
        ...
        <List spacing={12} withPadding listStyleType="disc" className="font-weight-500">
          ...
          <List.Item><span className="underline font-semibold">Minimal Data Retention:</span> We only use Amazon customer data (PII) for invoice generation. All Amazon customer data (PII) is automatically deleted within 30 days, in accordance with Amazon's Data Protection Policy (DDP).</List.Item>
  ...
  {
    id: "data-access",
    question: "What Amazon customer data (PII) does RunAnalytic access?",
    answer: (
      <span className="text-base">
  ...
  {
    id: "data-protection",
    question: "How does RunAnalytic protect Amazon customer data (PII)?",
    answer: (
      <span className="text-base">
        All Amazon customer data (PII) is encrypted in transit (TLS 1.2/1.3) and at rest (AES-256). Our systems are hosted on secure cloud infrastructure with firewalls, intrusion detection, and strict access controls. Access is logged and monitored continuously for suspicious activity.
      </span>
    )
  },
  {
    id: "data-storage",
    question: "Does RunAnalytic store or log Amazon customer data (PII)?",
    answer: (
      <span className="text-base">
  ...
  {
    id: "marketplaces",
    question: "Which Amazon marketplaces does RunAnalytic currently support?",
    answer: (
      <span className="text-base">
  ...
  },
  {
    ...
    question: "Who can access Amazon customer data (PII) within RunAnalytic?",
    answer: (
      <span className="text-base">
  ...
  {
    id: "password-rules",
    question: "What password and authentication rules do you enforce?",
    answer: (
      <span className="text-base">
  ...
  {
    id: "policies",
    question: "Which Amazon policies do you comply with?",
    answer: (
      <span className="leading-relaxed text-base">
        <List spacing={12} withPadding listStyleType="disc" className="text-md font-weight-500 pt-3">
          <List.Item>Amazon's SP-API <a href="https://sellercentral.amazon.es/mws/static/policy?documentType=AUP&locale=en_EN" target="_blank" className="hover:underline text-blue-600">Acceptable Use Policy</a>.</List.Item>
          <List.Item>Amazon's <a href="https://sellercentral.amazon.es/mws/static/policy?documentType=DPP&locale=en_EN" target="_blank" className="hover:underline text-blue-600">Data Protection Policy</a> (DPP).</List.Item>
  ...
  {
    id: "support",
    question: "How can I get support from RunAnalytic?",
    answer: (
      <span className="text-base">
  ...
  {
    id: "free-trial",
    question: "Does RunAnalytic offer a free trial?",
    answer: (
      <span className="text-base">
